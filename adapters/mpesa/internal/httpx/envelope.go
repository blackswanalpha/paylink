...
// work02/work03 reference template (payment-orchestrator / proof-validator internal/httpx).
package httpx
...
const (
	...
	CodeChargeNotFound       ErrorCode = "CHARGE_NOT_FOUND"
	CodeIdempotentConflict   ErrorCode = "IDEMPOTENT_CONFLICT"
	CodeProofRejected        ErrorCode = "PROOF_REJECTED"
	CodeDarajaUnavailable    ErrorCode = "DARAJA_UNAVAILABLE"
...
var httpStatus = map[ErrorCode]int{
	...
	CodeChargeNotFound:       http.StatusNotFound,
	CodeIdempotentConflict:   http.StatusConflict,
	CodeProofRejected:        http.StatusUnprocessableEntity,
	CodeDarajaUnavailable:    http.StatusBadGateway,
	CodeValidatorUnavailable: http.StatusBadGateway,
