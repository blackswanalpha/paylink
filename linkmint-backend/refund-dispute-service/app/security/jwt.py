"""RS256 access-token verification (PyJWT) — refund-dispute-service is a CONSUMER, not an issuer.

Unlike identity-service (which signs and verifies its own tokens), this service only *verifies*
