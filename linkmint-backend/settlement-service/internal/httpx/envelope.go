...
//
// Copied from the work20 escrow-manager Go/chi service template with the settlement-service
// error-code set.
package httpx
...
var httpStatus = map[ErrorCode]int{
	CodeSettlementNotFound: http.StatusNotFound,
	CodePayoutNotFound:     http.StatusNotFound,
