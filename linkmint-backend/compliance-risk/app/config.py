...
class Settings(BaseSettings):
    ...
    # starts the outbox-drain relay that drains compliance.compliance_events to the bus (ADR-011).
    # The durable outbox is always written in-transaction regardless of mode. ──
