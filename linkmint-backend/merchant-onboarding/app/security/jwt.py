"""RS256 access-token verification (PyJWT) — merchant-onboarding is a CONSUMER, not an issuer.

Unlike identity-service (which signs and verifies its own tokens), merchant-onboarding only
