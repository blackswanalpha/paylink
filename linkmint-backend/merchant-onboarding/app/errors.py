...
log = get_logger("merchant.errors")
...
class ErrorCode(StrEnum):
    ...
    # Organizations (claims-sourced; no memberships table here)
...
_HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.ALREADY_ONBOARDED: 409,
    ErrorCode.MERCHANT_NOT_FOUND: 404,
    ErrorCode.INVALID_TRANSITION: 409,
    ErrorCode.UNSUPPORTED_COUNTRY: 400,
    ErrorCode.INVALID_ACCOUNT: 422,
