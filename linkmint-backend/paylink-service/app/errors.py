...
log = get_logger("paylink.errors")


class ErrorCode(StrEnum):
    PAYLINK_NOT_FOUND = "PAYLINK_NOT_FOUND"
    INVALID_PAYLOAD = "INVALID_PAYLOAD"
    INVALID_QUERY = "INVALID_QUERY"
    IDEMPOTENT_CONFLICT = "IDEMPOTENT_CONFLICT"
    PAYLINK_ALREADY_SETTLED = "PAYLINK_ALREADY_SETTLED"
    PAYLINK_EXPIRED = "PAYLINK_EXPIRED"
    KYC_REQUIRED = "KYC_REQUIRED"  # SEAM (work12) — reserved, not enforced here
...
_HTTP_STATUS: dict[ErrorCode, int] = {
    ErrorCode.PAYLINK_NOT_FOUND: 404,
    ErrorCode.INVALID_PAYLOAD: 400,
    ErrorCode.INVALID_QUERY: 400,
    ErrorCode.IDEMPOTENT_CONFLICT: 409,
    ErrorCode.PAYLINK_ALREADY_SETTLED: 409,
    ErrorCode.PAYLINK_EXPIRED: 409,
    ErrorCode.KYC_REQUIRED: 402,
